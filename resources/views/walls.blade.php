        ...
        if (publicacion.innerHTML !== '<p><br></p>') {
            ...
            @endif
                $.ajax({
                    ...
                    {
                        var answer = "\'Answer\'";
                        var html = '<div class="social-avatar item-'+result.item+'"><a><img alt="image" class="img-circle" src="'+imagenUsuario+'"></a></div>\n\
